...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Ticket: {
      ...
      readonly status: 'ACTIVE' | 'USED' | 'CANCELLED';
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly ticket: {
              ...
              indexes: readonly [
                {
                  readonly name: 'tickets_active_session_seat_6544b081';
                  readonly prefix: 'tickets_active_session_seat';
                  readonly columns: readonly ['sessionId', 'seatId'];
                  readonly where: "(status <> 'CANCELLED')";
          ...
          readonly valueSet: {
            ...
            readonly TicketStatus: {
              readonly kind: 'valueSet';
              readonly values: readonly ['ACTIVE', 'USED', 'CANCELLED'];
            };
            readonly TicketType: {
              readonly kind: 'valueSet';
